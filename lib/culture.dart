                ...
                return Column(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        setState(() {
                          selectedPrices.add(cbooks[index].price);
                        });
                      },
                      child: Container(
                        width: 200,
                        ...
                        decoration: BoxDecoration(
                          image: DecorationImage(
                            image: AssetImage(cbooks[index].image),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Navigator.of(context).push(MaterialPageRoute(
                              ...
                              settings: RouteSettings(arguments: cbooks[index].toString()),
                            ));
                          },
                          child: Text('Details'),
                        ),
